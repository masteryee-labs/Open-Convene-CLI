...
OpenConveneCLI 開箱即支援 9 款 AI 程式碼代理 CLI：
...
| [OpenCode](https://opencode.ai) | 是 | 是 | 請見 [opencode.ai/docs/cli](https://opencode.ai/docs/cli/) |

> 每個 CLI 連接各自的模型後端。OpenConveneCLI 本身不依賴任何雲端服務。
